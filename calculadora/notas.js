...
esNotaValida = function (nota, idComponenteError) {
    ...
    //Comprobamos que el dato igresaso sea un numero
    if (isNaN(nota)) {
        mostrarTexto(idComponenteError, "Debe ingresar un número")
        hayErrores = true
    }
    //Verificas q el numero entre 0 y 10
    if (nota < 0 || nota > 10) {
        mostrarTexto(idComponenteError, "El número debe estar entre 0 y 10")
        hayErrores = true
    }
...
calcular2 = function () {
    ...
    nota1 = recuperarFloat("txtNota1");
    if (isNaN(nota1)) {
        mostrarTexto("lblError1", "Debe ingresar un número")
        existeError = true
    } else {
    ...
    nota2 = recuperarFloat("txtNota2");
    if (isNaN(nota2)) {
        mostrarTexto("lblError2", "Debe ingresar un número")
        existeError = true
    } else {
    ...
    nota3 = recuperarFloat("txtNota3");
    if (isNaN(nota3)) {
        mostrarTexto("lblError3", "Debe ingresar un número")
        existeError = true
    } else {
